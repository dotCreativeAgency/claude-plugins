...
| [wiki-pattern-plugin](./plugins/wiki-pattern-plugin) | 0.2.1 | Costruisce e mantiene wiki tecniche LLM-mantenute (pattern Karpathy esteso). 5 skill: bootstrap, upgrade, ingest, query, lint |
